...
// tests for TracksResponseTracksInner
void main() {
  final instance = TracksResponseTracksInnerBuilder();
  // TODO add properties to the builder and call build()

  group(TracksResponseTracksInner, () {
    ...
    // TracksResponseTracksInnerAllOfError error
